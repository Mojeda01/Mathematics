...
disp('Eigenvalue (Rayleigh Quotient Iteration):');
disp(rayleighEigenvalue);
disp('Eigenvector (Rayleigh QUotient Iteration):');
disp(rayleighEigenvector);

%% Step 5: Interpretation

clc

% Interpret the results to understand the variance and correlations in the
% portfolio

% Dominant eigenvalues indicates the largest vairance direction in the
% portfolio.

% Smallest eigenvalues indicates the smallest variance direction.

% Rayleigh quotient provides a refined eigenvalue estimation.p

disp('The dominant eigenvalue represents the direction of maximum variance in the portfolio.');
disp('The smallest eigenvalue represents the direction of minimum variance.');
disp('Rayleigh Quotient Iteration gives a refined eigenvalue estimation for any eigenvalue close to the initial guess.');